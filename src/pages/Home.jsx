...
const Home = () => {
    ...
    return (
        ...
        <div
            className="relative min-h-screen flex flex-col text-white overflow-x-hidden bg-cover bg-center bg-fixed"
        >
            ...
            <div className="relative z-10">
                ...
                <div className="relative flex flex-col md:flex-row items-center justify-center gap-8 mt-20 select-none">
                    ...
                    <div className="relative inline-block">
                        ...
                        <img
                            ...
                            className="w-28 h-28 object-contain cursor-pointer transition-all duration-500 ease-out hover:scale-105 active:scale-95 drop-shadow-lg"
                        />
                    </div>

                    <h1 className="text-5xl md:text-left text-center text-purple-200 font-extrabold tracking-wide">
                        Ghibli{" "}
